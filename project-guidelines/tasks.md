...
- [x] BUILT 2026-08-31 (Pane C). `/leadership/`: page per `project-sections/company/leadership.md` (hero, 3-up card grid, CtaBand) driven by `lib/leadership.ts` with 3 placeholder cards; noindex + out of sitemap.xml until real people land
