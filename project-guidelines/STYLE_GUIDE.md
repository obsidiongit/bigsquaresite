...
Scope note amending 4.5: the footer keeps the 1200px Container but NOT the hairline instrument (no GridLines, no ruled rows, no Nº labels, no mono meta). Interior pages and the nav keep the full instrument layer.
