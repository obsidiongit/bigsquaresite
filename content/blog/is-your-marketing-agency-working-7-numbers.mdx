...
If nobody has ever asked you for your close rate, nobody has ever calculated this. That is worth knowing.
...
If the sources say "unknown" or "other" for a big chunk of the list, tracking is broken. Fix that before you judge anything else.
