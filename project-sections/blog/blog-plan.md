...
| **Inline figures** | 2 or 3 per post where the post explains a number, a comparison, or a system (Brad approved the rendered system 2026-08-30 and wants more of them per post): a table, a diagram, a piece of math | `<Figure>` MDX component wrapping MediaSlot; the writer authors the figure HTML itself (section 2c) | Writer, end to end via `npm run blog:figures` |
