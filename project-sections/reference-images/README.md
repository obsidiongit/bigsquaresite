...
| `youtech-agency/pages/franchises/` | youtechagency.com/franchises/ | Industry-page structural capture (2026-08-25, Lane 3 brief): the structural model's own franchise page. Hero answer paragraph naming sub-verticals, franchise-angled service blocks with explore links, one deep case study, industry FAQ. Carries the template-stamping cautionary frame ("plumbing leads" on the franchises page). Desktop only; frames 11+ are duplicate footer states. |
| `ignite-visibility/pages/franchise-marketing-company/` | ignitevisibility.com/services/franchise-marketing-company/ | The page /industries/franchise/ must beat (2026-08-25, Lane 3 brief). Visible breadcrumb over the H1, persona-naming answer block, sub-vertical sectors section, named-framework pillars, on-page blog feed. Stat soup, ALL-CAPS case, badge walls, and icon-card grids do not transfer. Desktop only. |
